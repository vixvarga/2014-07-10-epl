...
layout: lesson
root: ../..
title: Working with Excel Reference
---

While Excel can do a lot, our goal is to work outside of Excel with a 
fully featured programming language like Python.  Our first step will be
converting from Excel's binary format to plain text.

#### Basic Operations

*   Convert Excel to CSV using "Save As" under the file menu and select CSV
